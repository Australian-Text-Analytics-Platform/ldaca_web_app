...
- [x] Regenerate OpenAPI and the frontend client.
- [x] Update durable engineering documentation.
- [ ] Synchronize the user-documentation mirror after its pinned submodule
  commit is available from the remote.
- [ ] Complete signed and notarized macOS bundle acceptance on a clean machine.
