...
metric is shared with Manual and Preview. Selected-column counts and scores cover
the complete current Data Block rather than only the visible Review page.
