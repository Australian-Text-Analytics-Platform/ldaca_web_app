...
pagination. The predicate and the grouped-count comparison query both normalise
...
source SQL, reference column, target column, and Codebook classes. A revealed column projects
