#!/usr/bin/env python3
"""
Run specific pytest tests - used for debugging specific test failures.

This script runs a predefined set of tests with detailed output.
For general verification of SSE and progress fixes, use verify_fixes.py instead.
"""
