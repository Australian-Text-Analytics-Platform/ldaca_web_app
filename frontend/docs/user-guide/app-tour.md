...
## Step 2 — Workspaces and nodes

**Question:** *What is a workspace in the UI?*

**Answer:** A workspace is a project container. Nodes inside it represent datasets and analysis results.

## Step 3 — Data Loader tab

**Question:** *How do I bring data into the app?*

**Answer:** Use the Data Loader tab to upload files and add them to a workspace as nodes.
