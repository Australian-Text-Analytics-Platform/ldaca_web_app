...
**Question:** *What should I validate before publishing?*

**Answer:** Ensure the production build succeeds and the CLI command runs locally.
...
**Question:** *Where are the exact release commands?*

**Answer:** Use the release checklist for the frontend package in this repository.
