...
vi.mock('@/features/auth/hooks/useAuth', () => ({
  // Supplies the auth hook contract without coupling snapshot tests to login state.
...
// Builds quotation snapshot manifests with overridable fields for load-path tests.
/**
