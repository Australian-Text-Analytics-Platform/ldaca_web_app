 ...
 * Called by `formatFilterConditionToken` to encode a condition value.
 ...
 * Called by `buildFilterAutoNodeName` for each complete condition.
 ...
 * Used by `useFilterSubTabSections` when deriving the default output-node name.
