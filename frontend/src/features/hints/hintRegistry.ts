...
export const hintRegistry: HintDefinition[] = [
  ...
  },
  {
    ...
    // Invoked by hint policy when this runtime-path hint is evaluated.
  ...
  },
  {
    ...
    // Invoked by hint policy when the empty-column condition is evaluated.
    resolveAnchor: () => {
