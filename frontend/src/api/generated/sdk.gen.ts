 ...
 */
export const clearTopicModelingEmbeddingCache = <ThrowOnError extends boolean = false>(options?: Options<ClearTopicModelingEmbeddingCacheData, ThrowOnError>): RequestResult<ClearTopicModelingEmbeddingCacheResponses, ClearTopicModelingEmbeddingCacheErrors, ThrowOnError> => (options?.client ?? client).delete<ClearTopicModelingEmbeddingCacheResponses, ClearTopicModelingEmbeddingCacheErrors, ThrowOnError>({ url: '/api/workspaces/topic-modeling/embedding-cache', ...options });
 ...
 */
export const getTopicModelingEmbeddingCacheSize = <ThrowOnError extends boolean = false>(options?: Options<GetTopicModelingEmbeddingCacheSizeData, ThrowOnError>): RequestResult<GetTopicModelingEmbeddingCacheSizeResponses, GetTopicModelingEmbeddingCacheSizeErrors, ThrowOnError> => (options?.client ?? client).get<GetTopicModelingEmbeddingCacheSizeResponses, GetTopicModelingEmbeddingCacheSizeErrors, ThrowOnError>({ url: '/api/workspaces/topic-modeling/embedding-cache/size', ...options });
