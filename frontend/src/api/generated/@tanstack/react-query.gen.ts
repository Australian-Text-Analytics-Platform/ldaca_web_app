...
export const getAnnotationClassDescriptionsQueryKey = (options: Options<GetAnnotationClassDescriptionsData>) => createQueryKey('getAnnotationClassDescriptions', options, false, ['workspace_management', 'annotation']);
